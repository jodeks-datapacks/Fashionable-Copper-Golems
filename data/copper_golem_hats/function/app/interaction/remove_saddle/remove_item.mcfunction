...
$execute unless data entity @e[type=copper_golem,limit=1,tag=has_interaction.copper_golem_hats] equipment.saddle.components run \
...
item replace entity @e[type=copper_golem,limit=1,tag=has_interaction.copper_golem_hats] saddle with air
