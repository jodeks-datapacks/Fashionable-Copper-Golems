...
$execute unless data entity @e[type=copper_golem,limit=1,tag=has_interaction.fashionablecoppergolems] equipment.saddle.components run \
...
item replace entity @e[type=copper_golem,limit=1,tag=has_interaction.fashionablecoppergolems] saddle with air
